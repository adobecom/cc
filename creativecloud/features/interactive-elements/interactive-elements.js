...
const interactiveElements = await import('./interactive-elements.css', {
  assert: { type: 'css' }
});
document.adoptedStyleSheets = [interactiveElements.default];
...
export function createEnticement(enticementDetail, mode) {
  ...
  const svgImage = createTag('img', { class: 'enticementArrow' });

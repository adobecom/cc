...
export default async function init(el) {
  ...
  showcaseContentElem.querySelector(':scope > div').classList.add('content-container');
  // Decorate buttons

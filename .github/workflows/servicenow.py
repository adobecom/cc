...
if __name__ == "__main__":
  ...
  data = {
    ...
    "instanceIds": [ 321835,512580 ],
    "plannedStartDate": start_time,
    "plannedEndDate": end_time,
    "coordinator": "venkatas@adobe.com",
    ...
    "approvedBy": [ "sann@adobe.com", "dstrong@adobe.com", "saljain@adobe.com", "wcms-ops@adobe.com" ],
    "testPlan": "Test plan is documented in the PR link in the CC Milo repository above. See the PR's merge checks to see Unit and Nala testing.",
    "implementationPlan": "The change will be released as part of the continuous deployment of CC Milo's production branch, i.e., \"main\"",
    "backoutPlan": "Revert merge to the CC Milo production branch by creating a revert commit.", "testResults": "Changes are tested and validated successfully in staging environment. Please see the link of the PR in the description for the test results."
  }
